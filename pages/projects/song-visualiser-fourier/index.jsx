...
export default function Project() {
    ...
    >
        ...
        <div className={styles.video}>
            ...
            />
            <p title="There are other songs that demonstrate this viz better, but I needed something that YouTube wouldn't take down..">
        ...
        <p>
            ...
            But I guess I completed what I originally wanted to achieve, so moved onto my next project 🤷.
        </p>
        ...
        <p>
            It is essentially lots of iterative "wrapping" of a waveform around the origin at different speeds (frequencies),
            where the deviation of the mean of the wrapped waveform from the origin represents the prevalence of that
