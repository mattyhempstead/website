...
class Main {
	...
	update(timestamp) {
        ...
        for (let i=0; i<16; i++) this.sim.update()
...
// 2023: Use setInterval to ensure 60fps across different refresh rates
let startTime = new Date().getTime();
window.setInterval(()=>mainLoop(new Date().getTime()-startTime), 1000/60);
